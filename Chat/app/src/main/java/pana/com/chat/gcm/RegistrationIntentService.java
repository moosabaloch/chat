...
import pana.com.chat.apicall.UpdateUserGCM;
...
public class RegistrationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            String token = instanceID.getToken(Utils.SENDER_ID, GoogleCloudMessaging.INSTANCE_ID_SCOPE, null);
            // [END get_token]
    ...
    private void sendRegistrationToServer(final String token) {
        ...
        PostReq.getMyInstance().registerID(token);
    // Update user data in firebase to notify
        UpdateUserGCM.getInstance().updateUserDataOnFirebase(token);
    }
